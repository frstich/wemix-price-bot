...
intents.members = True # You might not need this if you only update nickname/channel
    ...
    while not client.is_closed():
        ...
        if price is not None:
            ...
            try:
                ...
                activity = discord.Activity(type=discord.ActivityType.watching, name=f"{ACTIVITY_TEXT} {price_display}")
